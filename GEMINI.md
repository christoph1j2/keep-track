...
- **Confirmation Modals**: Prefer using confirmation modals or dialogs to ask the user for secondary configurations (like "Use AI?") _after_ they have triggered the primary action, but _before_ committing the action.
