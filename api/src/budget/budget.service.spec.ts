...
describe('BudgetService', () => {
  ...
  describe('create', () => {
    it('should throw BadRequestException if category not found', async () => {
      ...
      await expect(
        service.create('user-1', { categoryId: '1', limit: 1000 }),
  ...
  describe('update', () => {
    it('should update a budget', async () => {
      ...
      expect(await service.update('user-1', '1', dto)).toEqual({
        ...budget,
        ...dto,
      });
    });
  ...
  describe('reorder', () => {
    it('should throw NotFoundException if a budget is missing', async () => {
      ...
      await expect(
        service.reorder('user-1', { budgets: [{ id: '1', order: 1 }] }),
