...
export function ComplexBudget() {
  ...
  // Calculate total income and surplus, it is good to show the user that they have extra income that can be used for other expenses or savings. This provides a more complete picture of their financial situation.
  ...
  const enrichedCategories =
    complexBudget?.categories?.map((budgetCat) => {
