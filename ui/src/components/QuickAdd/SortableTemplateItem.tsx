...
export function SortableTemplateItem({
  ...
  const icon = category ? (
    ...
    <CategoryIcon name="QuestionMark" />
  );
      ...
      {compact ? (
        <div className="relative p-2 rounded-xl bg-slate-50 border border-slate-100 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-300">
          ...
          <div className="pt-4 px-3">
            <QuickAddButton
              ...
              colorClass={
                category?.colorClass ||
                "bg-gray-200 text-gray-800 dark:bg-slate-600 dark:text-slate-300"
              }
        ...
        <div className="flex flex-col gap-4 p-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-4 min-w-0">
            ...
            <div
              className={`p-2 rounded-lg ${category?.colorClass || "bg-gray-200 text-gray-800 dark:bg-slate-600 dark:text-slate-300"}`}
            >
              {icon}
            </div>
            <div className="min-w-0">
              <div className="font-bold text-slate-800 dark:text-slate-300 truncate">
                {template.title}
              </div>
